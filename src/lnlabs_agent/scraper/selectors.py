...
SELECTORS: dict[str, List[str]] = {
    ...
    "profile_mutuals_link": [
        ...
        "a:has(span:has-text('Mutual connection'))",
        "a:has-text('Mutual connection')",
        "a:has(span:has-text('are mutual connections'))",
        "a:has-text('are mutual connections')",
        "a:has(span:has-text('is a mutual connection'))",
        "a:has-text('is a mutual connection')",
        ...
        "button:has(span:has-text('Mutual connection'))",
        "button:has-text('Mutual connection')",
        "button:has(span:has-text('mutuals'))",
        "button:has-text('mutuals')",
        "button:has(span:has-text('Mutuals'))",
        "button:has-text('Mutuals')",
    ],
    "search_filters_nav": [
